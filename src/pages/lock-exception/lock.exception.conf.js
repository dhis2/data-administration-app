...
export const PAGE_SUMMARY = 'Lock exceptions provide fine-grained control over exemption from a locked data set.' +
    ...
    ' through the Lock exception interface. To enable a lock exception, select the desired organization units, data' +
    ' sets, and time period and press "Add". By granting a lock exception, data entry will be enabled even after the' +
